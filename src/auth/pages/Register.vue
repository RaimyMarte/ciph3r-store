<template>
  <AuthLayout title="Registro">
    <v-form @submit.prevent="register" v-model="isValid">
      <v-text-field v-model="name" :rules="nameRules" label="Nombre" prepend-icon="mdi-account" required></v-text-field>

      <v-text-field v-model="email" :rules="emailRules" label="Correo" prepend-icon="mdi-email" required></v-text-field>

      <v-text-field v-model="password" :rules="passwordRules" label="Contraseña" prepend-icon="mdi-lock" type="password"
        required></v-text-field>

      <v-text-field v-model="confirmPassword" :rules="[...passwordRules, passwordMatchRule]"
        label="Confirmar Contraseña" prepend-icon="mdi-lock-check" type="password" required></v-text-field>
